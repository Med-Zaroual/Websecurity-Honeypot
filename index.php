...
try{
	...
	if ( $_SESSION['user_type'] == "user" && ($action == "admin" || $action == "disable" || $action == "enable") ){
		$action = "user";	
	}
...
//need more catch and detailed exploration of exeption this is quite shit even tho i can'y grassep how to make it better 
